...
public class WelcomeInterfaceActivity extends Activity {
	...
	private void notifyPage() {
		...
		View view1 = mLi.inflate(R.layout.welcome_tab1, null);
		View view2 = mLi.inflate(R.layout.welcome_tab2, null);
		View view3 = mLi.inflate(R.layout.welcome_tab3, null);
		View view4 = mLi.inflate(R.layout.welcome_tab4, null);
